...
public class SU_AsteroidField : MonoBehaviour {	
    ...
    public static SU_AsteroidField asteriodField;
    public GameObject AsteriodHolder;
	...
	void OnEnable () {
        ...
        AsteriodHolder = new GameObject();
        AsteriodHolder.gameObject.name = "Asteriod Holder";
	...
	void SpawnAsteroids(bool atSpawnDistance) {
		...
		while (_asteroids.Count < maxAsteroids) {
            ...
            _newAsteroid.transform.parent = AsteriodHolder.transform;
